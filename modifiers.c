 ...
 * @printed: The current number of characters already printed to output for a given number specifier.
 ...
 * @output: A buffer_t struct containing a character array.
 * @printed: The current number of bytes already stored to output for a given specifier.
 * @flags: Flag modifiers.
 * @wid: A width modifier.
 *Return: The number of bytes stored to the buffer.
 */
